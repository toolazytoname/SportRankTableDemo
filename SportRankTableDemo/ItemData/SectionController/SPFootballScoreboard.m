...
#import "SPFootballScoreboard.h"

@implementation SPFootballScoreboard
-(void)requestData
{
    [self requestChinaSuperTeamRank];
}
-(void)requestChinaSuperTeamRank
{
    ...
    if(data_from&&itemID)
    {
        ...
        [self addRequest:[SPFootballTeamRankRequest requestWithDelegate:self parameters:paramDic isUseCache:YES]];
    }
...
{
    self.dataList = [request.resultDataDic objectForKeyNotNull:SPFootballTeamRankKey];
