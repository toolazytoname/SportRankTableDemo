...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
            ...
            self.teamOrder = [[self objectOrNilForKey:kSPFootballTeamOrderItemTeamOrder fromDictionary:dict] doubleValue];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:[NSNumber numberWithDouble:self.teamOrder] forKey:kSPFootballTeamOrderItemTeamOrder];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.teamOrder = [aDecoder decodeDoubleForKey:kSPFootballTeamOrderItemTeamOrder];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeDouble:_teamOrder forKey:kSPFootballTeamOrderItemTeamOrder];
